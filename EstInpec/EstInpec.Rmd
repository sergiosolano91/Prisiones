...
```{r tasa encarcelamiento curva, fig.height=7}
...
DaneInpecPry %>%filter(!(Edad %in% c("0 - 17"))) %>% ggplot() + geom_bar(aes(x=Fecha,y=PobCar_pry,fill = Edad), stat="identity") + facet_wrap(~Sexo, scales = "free") + theme_minimal() 
```
