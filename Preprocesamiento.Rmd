...
sarima(ts_total,1,1,1,0,0,2, S = 12, details = FALSE)
```
...
sarima.for(ts_total,n.ahead = 36, 1,1,1,0,0,2, S = 12)
```
...
sarima.for(ts_sin,n.ahead = 36, 1,1,1,0,0,1, S = 12)
```
...
sarima.for(ts_con,n.ahead = 36, 1,1,1,0,0,1, S = 12)
```
