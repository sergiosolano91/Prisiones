...
residuales_out_arima_total_4 <- (abs(residuales_arima_total_4)>3000)*1
...
# Filtrar contra un umbral
residuales_out_arima_sindi_3 <- (abs(residuales_arima_sindi_3)>3000)*1
...
# Filtrar contra un umbral
residuales_out_arima_conde_1 <- (abs(residuales_arima_conde_1)>3000)*1
