...
autoplot(as.zoo(DeltaMPP$seasonal), geom = "line") + ylab("tasa de crecimiento - componente estacional") + xlab("Periodo") -> graf_estacionalidad
graf_estacionalidad
...
autoplot(as.zoo(DeltaMPP$random), geom = "line") + ylab("tasa de crecimiento - error") + xlab("Periodo") -> graf_error
graf_error
