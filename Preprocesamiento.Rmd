...
Asumiendo que la serie tiene una tendencia.

```{r estima_arima, echo = FALSE, include = TRUE}
sarima(ts_total,1,1,0,0,0,1, S = 12, details = FALSE)
```

``` {r proyecta, echo = FALSE}
sarima.for(ts_total,n.ahead = 36,1,1,0,0,0,1, S = 12)
```
